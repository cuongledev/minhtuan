									...
									foreach ($data as $k => $v) {?>
											  ...
											  <div class="modal fade" id="confimModal<?php echo $v['id'];?>" role="dialog">
											    <div class="modal-dialog">
											      ...
											      <div class="modal-content">
											        ...
											        <div class="modal-body">
													       <li class="list-group-item list-group-item-warning">Bạn chắc chắc muốn xóa đơn hàng này ?</li>
											        </div>
											        <div class="modal-footer">
											          <a href="<?php echo base_url()."$module/order/del/".base64url_encode($v['id']);?>" class="btn green">Đồng ý</a>
											          <button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
											        </div>
											      </div>
											...
											<tr id="tr_<?php echo $v['id'];?>" data-key="<?php echo $v['id'];?>">
												...
												<td class="hidden-xs" style="vertical-align: middle;">		
													<?php echo date("H:i:s d-m-Y",$v['create_time']);?>
												</td>
												
												<td class="icon_btn" style="vertical-align: middle;">
													<a href="<?php echo base_url(); ?>backend/order/detail/<?php echo $v['id'];?>" class="btn btn-xs green tooltips btn_lnc_fix" data-original-title="Xem chi tiết"><i class="fa fa-eye"></i> Xem chi tiết</a>
