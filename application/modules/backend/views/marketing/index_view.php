							    ...
							    <div class="modal-dialog">
							      ...
							      <div class="modal-content">
							        ...
							        <div class="modal-body">
									       <li class="list-group-item list-group-item-warning">Bạn chắc chắc muốn xóa những email này ?</li>
							        </div>
								...
								if(!empty($data)){
									foreach ($data as $k => $v) {?>
											  ...
											  <div class="modal fade" id="confimModal<?php echo $v['id'];?>" role="dialog">
											    <div class="modal-dialog">
											      ...
											      <div class="modal-content">
											        ...
											        <div class="modal-body">
													       <li class="list-group-item list-group-item-warning">Bạn chắc chắc muốn xóa email này ?</li>
											        </div>
											        <div class="modal-footer">
											...
											<tr id="tr_<?php echo $v['id'];?>" data-key="<?php echo $v['id'];?>">
												...
												<td >
													<?php echo (isset($v['email']) && $v['email']!='') ? $v['email'] : 'Chưa cập nhập.';?>
													
												</td>
												<td >
													<?php echo (isset($v['job']) && $v['job']!='') ? $v['job'] : 'Chưa cập nhập.';?>
													
												</td>
												<td class="hidden-xs">		
													<?php echo (isset($v['working_location']) && $v['working_location']!='') ? $v['working_location'] : 'Chưa cập nhập.';?>
												</td>
												<td class="hidden-xs">		
												...
												<td class="icon_btn">
													<a href="<?php echo base_url()."$module/marketing/edit/".base64url_encode($v['id']);?>" class="btn btn-xs yellow tooltips btn_lnc_fix" data-placement="top" ><i class="fa fa-edit"></i> Sửa</a>
