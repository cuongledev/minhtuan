									...
									foreach ($data as $k => $v) {?>
											...
											<tr id="tr_<?php echo $v['id'];?>" data-key="<?php echo $v['id'];?>">
												...
												<td style="vertical-align: middle;">
													<?php 
													if($v['status_home']==1){?>
															<a class="btn default btn-xs green-stripe status_home" data-id="<?php echo $v['id'];?>" data-status="<?php echo $v['status_home'];?>" style="width:125px;color: #333333;background-color: #e5e5e5;">Đang hiện</a>
													<?php }else{?>
															<a class="btn default btn-xs red-stripe status_home" data-id="<?php echo $v['id'];?>" data-status="<?php echo $v['status_home'];?>" style="width:125px;color: #333333;background-color: #e5e5e5;">Đang ẩn</a>
													<?php }
													 ?>
												</td>
												<td class="hidden-xs" style="vertical-align: middle;">	
