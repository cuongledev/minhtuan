<div class="col-md-12" id="company">
		...
		<div class="portlet">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-users"></i> Quản lý hồ sơ công ty
				</div>
			</div>
		...
		<form class="form-horizontal form-row-seperated" action="<?php if(isset($action)) echo $action; ?>" id="form_infolist" class="form-horizontal" enctype="multipart/form-data" method="POST">
					<div class="col-md-3 col-padding-10">
						...
						<div class="actions btn-set">
							<a href="<?php echo base_url()."$module/company/add";?>" class="btn btn-success btn-sm green continue"><i class="fa fa-plus"></i> Thêm mới</a>
						</div>
								...
								if(!empty($data)){
									foreach ($data as $k => $v) {?>
											  ...
											  <div class="modal fade" id="myModal<?php echo $v['id'];?>" role="dialog">
											    <div class="modal-dialog">
											      ...
											      <div class="modal-content">
											        <div class="modal-header">
											          <button type="button" class="close" data-dismiss="modal">&times;</button>
											          <h4 class="modal-title">Thông tin chi tiết tài khoản <?php echo $v['company_name'];?></h4>
											        </div>
											        <div class="modal-body">
											        		<div class="col-md-6 table_td">Logo công ty:</div>
													       <div class="col-md-6 table_td"><img style="    width: 60px;" src="<?php echo !empty($v['logo']) ? $v['logo'] : base_url().'public/'.$module.'/images/no_image.gif';?>"/></div>
													       ...
													       <div class="clearfix"></div>
													       <div class="col-md-6 table_td">Giám đốc:</div>
													       <div class="col-md-6 table_td"><?php echo !empty($v['boss']) ? $v['boss'] : '<span style="color:red">Chưa cập nhật</span>';?></div>
													       <div class="clearfix"></div> 
													       ...
													       <div class="clearfix"></div> 
													       <div class="col-md-6 table_td">Website:</div>
													       <div class="col-md-6 table_td"><?php echo !empty($v['company_website']) ? $v['company_website'] : '<span style="color:red">Chưa cập nhật</span>';?></div>
													       <div class="clearfix"></div> 
													       ...
													       <div class="clearfix"></div> 
													       <div class="col-md-6 table_td">Lĩnh vực hoạt động:</div>
													       <div class="col-md-6 table_td"><?php echo !empty($v['fields']) ? $v['fields'] : '<span style="color:red">Chưa cập nhật</span>';?></div>
													       <div class="clearfix"></div> 
													       ...
													       <div class="col-md-6 table_td">Tài khoản công ty</div>
													       <div class="clearfix"></div> 
											  ...
											  <div class="modal fade" id="confimModal<?php echo $v['id'];?>" role="dialog">
											    <div class="modal-dialog">
											      ...
											      <div class="modal-content">
											        ...
											        <div class="modal-footer">
											          <a href="<?php echo base_url()."$module/company/del/".base64url_encode($v['id']);?>" class="btn green">Đồng ý</a>
											          <button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
											        </div>
											      </div>
											...
											<tr id="tr_<?php echo $v['id'];?>" data-key="<?php echo $v['id'];?>">
												...
												<td >
													<?php echo !empty($v['company_name']) ? $v['company_name'] : '<span style="color:red">Chưa cập nhật</span>';?>
												...
												<td>
													<?php 
													if($v['status']==1){?>
															<a class="btn default btn-xs green-stripe active_status active_fix" data-id="<?php echo $v['id'];?>" data-status="<?php echo $v['status'];?>" style="width:125px;color: #333333;background-color: #e5e5e5;">Đang hiện</a>
													<?php }else{?>
															<a class="btn default btn-xs red-stripe active_status active_fix" data-id="<?php echo $v['id'];?>" data-status="<?php echo $v['status'];?>" style="width:125px;color: #333333;background-color: #e5e5e5;">Đang ẩn</a>
													<?php }
													 ?>
												</td>
												<td class="icon_btn">
													...
													<a href="<?php echo base_url()."$module/company/edit/".base64url_encode($v['id']);?>" class="btn btn-xs yellow tooltips btn_lnc_fix" data-placement="top" data-original-title="{lang edit}"><i class="fa fa-edit"></i> Sửa</a>
