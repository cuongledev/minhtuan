							...
							<div class="tab-pane active">
								<div class="form-body">	
										...
										<div class="col-md-5">
											<div class="panel panel-info" style="border-radius: 0px;">
										      ...
										      <div class="panel-body" style="height: 110px;overflow-y: scroll;">
										      	<?php 
													dequyInProduct($menu,$parent=0,$text="------",$cate);
													?>
										  	</div>
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<input type="text" class="form-control maxlength-handler" id="dai" name="dai" value="<?php echo (isset($info['weigh_class']) && $info['weigh_class']!='') ? $info['weigh_class'] : ''; ?>" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-5">
											<input type="text" class="form-control maxlength-handler" id="baohanh" name="baohanh" value="<?php echo (isset($info['baohanh']) && $info['baohanh']!='') ? $info['baohanh'] : ''; ?>" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea name="info_short" cols="30" rows="6" class="form-control ckeditor maxlength-handler"><?php if(isset($info['info_short'])) echo $info['info_short'];?></textarea>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control ckeditor" name="content_editor_product" cols="30" rows="6"><?php if (isset($info['full_info']) && $info['full_info']!='') {
												echo $info['full_info'];
											} ?></textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control ckeditor" name="mota_content_editor_product" cols="30" rows="6"><?php if (isset($info['mota']) && $info['mota']!='') {
												echo $info['mota'];
											} ?></textarea>
									...
									<div class="form-group">
											...
											<div id="createColor" class="col-md-10">
												...
												<?php 
												if (isset($info['color']) && $info['color']!='') {
													$color = json_decode($info['color']);
													$i= 1;
													foreach ($color as $key => $value) { ?>
														<div class='fileinput' data-provides='fileinput'>
											                <input type='hidden' name='colorImage[]' value="<?php echo (isset($value->color)) ? $value->color : '#000';?>" id='color' />
											                <div class="fileinput-new thumbnail logo_thumbnail<?php echo $i;?>" style="width: 110px; height: 60px;">
											                  <img src="<?php 
																	echo (isset($value->image)) ? base_url().$value->image : base_url().'public/'.$module.'/images/no_image.gif'; 
																
																 ?>" class="image_<?php echo $i;?>" alt='Avatar'/>
											                  <input type="hidden" value="<?php echo (isset($value->image)) ? $value->image : '';?>" name="hidden_imgColor[]" id="hidden_imgColor<?php echo $i;?>" class="hidden_imgColor"/>
											                </div>
											                <div>
											                  <span class='btn default btn-file'>
											                  <span class='fileinput-exists btn btn-success'>
											                  Thay ảnh </span>
											                  <input type="file" name="file_logoColor[]" class="file_logoColor" id="file_logoColor<?php echo $i;?>" />
											                  </span>
										...
										<div class="col-md-10">
											<div class="panel panel-info" style="border-radius: 0px;">
										      ...
										      <div class="panel-body" style="height: 170px;overflow-y: scroll;"> -->
										      	<?php 
										      	/*if (isset($info['related_product']) && $info['related_product']!='') {
										      		$related_product = json_decode($info['related_product'],true);
										      	}
												if (!empty($relax) && $related_product!='') {
													foreach ($relax as $key => $value) {
														$x = (in_array($value['id'], $related_product)) ? ' checked' : '';
														echo '<p><input type="checkbox" '.$x.' name="relax[]" value="'.$value['id'].'" /> '.$value['title'].'</p>';
													}
												}*/
												?>
										  	<!-- </div>
