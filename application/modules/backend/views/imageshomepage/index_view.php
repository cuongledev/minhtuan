<div class="col-md-12" id="Imageshomepage">
	...
	<form class="form-horizontal form-row-seperated" action="<?php if(isset($action)) echo $action; ?>" id="form_infolist" class="form-horizontal" enctype="multipart/form-data" method="POST">
		<div class="portlet">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-picture-o" aria-hidden="true"></i> Quản lý ảnh trang chủ
				</div>
			</div>
				...
				<div class="form-group row-search">
					...
					<div class="col-md-3 col-padding-10">
							    ...
							    <div class="modal-dialog">
							      ...
							      <div class="modal-content">
							        ...
							        <div class="modal-body">
									       <li class="list-group-item list-group-item-warning">Bạn chắc chắc muốn xóa những ảnh này ?</li>
							        </div>
						...
						<div class="actions btn-set">
							<a href="<?php echo base_url()."$module/imageshomepage/add";?>" class="btn btn-success btn-sm green continue"><i class="fa fa-plus"></i> Thêm mới</a>
						</div>
									...
									foreach ($data as $k => $v) {?>
											  ...
											  <div class="modal fade" id="confimModal<?php echo $v['id'];?>" role="dialog">
											    <div class="modal-dialog">
											      ...
											      <div class="modal-content">
											        ...
											        <div class="modal-body">
													       <li class="list-group-item list-group-item-warning">Bạn chắc chắc muốn xóa ảnh này ?</li>
											        </div>
											        <div class="modal-footer">
											          <a href="<?php echo base_url()."$module/imageshomepage/del/".base64url_encode($v['id']);?>" class="btn green">Đồng ý</a>
											          <button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
											        </div>
											      </div>
											...
											<tr id="tr_<?php echo $v['id'];?>" data-key="<?php echo $v['id'];?>">
												...
												<td style="vertical-align: middle;">
													<img style="width: 100px;margin-bottom:0px;" class="thumbnail" src="<?php echo (isset($v['images']) && $v['images']!='') ? base_url().$v['images'] : base_url().'public/backend/images/no_image.gif';?>" />
													
												</td>
												<td style="vertical-align: middle;">
													<?php echo (isset($v['title']) && $v['title']!='') ? $v['title'] : '';?>
												...
												<td class="icon_btn" style="vertical-align: middle;">
													...
													<a href="<?php echo base_url()."$module/imageshomepage/edit/".base64url_encode($v['id']);?>" class="btn btn-xs yellow tooltips btn_lnc_fix" data-placement="top" data-original-title="{lang edit}"><i class="fa fa-edit"></i> Sửa</a>
