	...
	<form class="form-horizontal form-row-seperated" action="<?php if(isset($action)) echo $action; ?>" id="form_infolist" class="form-horizontal" enctype="multipart/form-data" method="POST">
		<div class="portlet">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-picture-o" aria-hidden="true"></i> Quản lý slider
				</div>
			</div>
				...
				<div class="form-group row-search">
					...
					<div class="col-md-3 col-padding-10">
						...
						<div class="actions btn-set">
							<a href="<?php echo base_url()."$module/slider/add";?>" class="btn btn-success btn-sm green continue"><i class="fa fa-plus"></i> Thêm mới</a>
						</div>
									...
									foreach ($data as $k => $v) {?>
											  ...
											  <div class="modal fade" id="confimModal<?php echo $v['id'];?>" role="dialog">
											    <div class="modal-dialog">
											      ...
											      <div class="modal-content">
											        ...
											        <div class="modal-footer">
											          <a href="<?php echo base_url()."$module/slider/del/".base64url_encode($v['id']);?>" class="btn green">Đồng ý</a>
											          <button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
											        </div>
											      </div>
											...
											<tr id="tr_<?php echo $v['id'];?>" data-key="<?php echo $v['id'];?>">
												...
												<td class="icon_btn" style="vertical-align: middle;">
													...
													<a href="<?php echo base_url()."$module/slider/edit/".base64url_encode($v['id']);?>" class="btn btn-xs yellow tooltips btn_lnc_fix" data-placement="top" data-original-title="{lang edit}"><i class="fa fa-edit"></i> Sửa</a>
