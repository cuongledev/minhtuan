...
*/
class Setting_panel extends AdminController{
    protected $_data;
    ...
    public function add(){
        ...
        $this->_data['page_breadcrumb'] = array(
            0 => array(
                'name' => 'Quản lý OEM',
                'href'  => base_url().$module.'/setting_panel/index'
                ),
            1 => array(
                'name' => 'Thêm mới OEM',
                'href'  => ''
        ...
        $this->_data['loadPage']="setting_panel/edit_view";
        $this->_data['action'] = base_url().'backend/setting_panel/insertSchools';
        $this->_data['link_button_back'] = base_url().'backend/setting_panel/index';
