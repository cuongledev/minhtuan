										...
										<div class="product-single col-xs-6 col-sm-6 col-md-4">
											<div class="product-images col-xs-12 noPadding">
												<div class="behind-images hidden-xs hidden-sm col-md-12 noPadding">
													<a href="<?php if(isset($value['id'])) echo base_url().'san-pham/'.$value['id'].'-'.alias($value['title']).'.htm'; ?>"><img src="<?php echo ($value['thumbnail_after']!='') ? base_url().'image_tools/timthumb.php?src='.base_url().$value['thumbnail_after'].'&h=580&w=450&zc=2' : base_url().'image_tools/timthumb.php?src=public/backend/images/no_image.gif&h=580&w=450&zc=2';?>" alt="" class="img-responsive" width="450" height="580"></a>
												</div>
												<div class="front-images col-xs-12 noPadding">
													<a href="<?php if(isset($value['id'])) echo base_url().'san-pham/'.$value['id'].'-'.alias($value['title']).'.htm'; ?>"><img src="<?php echo ($value['thumbnail']!='') ? base_url().'image_tools/timthumb.php?src='.base_url().$value['thumbnail'].'&h=580&w=450&zc=2' : base_url().'image_tools/timthumb.php?src=public/backend/images/no_image.gif&h=580&w=450&zc=2';?>" alt="" class="img-responsive" width="450" height="580"></a>
												</div>
											</div>
											<div class="product-detail col-xs-12 noPadding">
												<a href="<?php if(isset($value['id'])) echo base_url().'san-pham/'.$value['id'].'-'.alias($value['title']).'.htm'; ?>"><p class="product-name"><?php echo (isset($value['title'])) ? $value['title'] : ''; ?></p></a>
