	          ...
	          <li>
	            <ul class="menu">
	              <li>
	                <a href="#">
	                  <div class="pull-left">
	                    <img src="<?php echo base_url() ?>public/<?php echo $module;?>/images/user2-160x160.jpg" class="img-circle" alt="User Image" />
	                  </div>
	                  <h4>
	                    Support Team
	              ...
	              <li>
	                <a href="#">
	                  <div class="pull-left">
	                    <img src="<?php echo base_url() ?>public/<?php echo $module;?>/images/user3-128x128.jpg" class="img-circle" alt="User Image" />
	                  </div>
	                  <h4>
	              ...
	              <li>
	                <a href="#">
	                  <div class="pull-left">
	                    <img src="<?php echo base_url() ?>public/<?php echo $module;?>/images/user4-128x128.jpg" class="img-circle" alt="User Image" />
	                  </div>
	                  <h4>
	                    Developers
	      ...
	      <li class="dropdown user user-menu">
	        ...
	        <ul class="dropdown-menu">
	          ...
	          <li class="user-header">
	            ...
	            <p>
	              Lê Ngọc Cường - Web Developer
	              <small>cuongle.dev@gmail.com</small>
	            </p>
	          </li>
	          <!-- Menu Footer-->
